...
function canvasMain(canvasName)
{
	...
	var floor = new c3dl.Collada();
	floor.init('floor.dae');
	floor.translate([0,-100,0]);
	floor.scale([2800,1,3000]);
	scn.addObjectToScene(floor);
	
	scn.setPointRenderingMode(c3dl.POINT_MODE_POINT);
	scn.setAmbientLight([0,0.2,0]);
	...
	scn.setMouseCallback(mouseUp, mouseDown, mouseMove, updateScroll);
