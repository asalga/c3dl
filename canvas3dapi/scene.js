...
/*	this.getTextureID = function(path)
  ...
  /**
	...
	*/
	this.setCamera = function(cam)
	{
		...
		if (cam instanceof c3dl.FreeCamera ||
			cam instanceof c3dl.OrbitCamera)
	...
	*/
	...
	{
		if(	precision == c3dl.PICK_PRECISION_BOUNDING_VOLUME ||
			precision == c3dl.PICK_PRECISION_TRIANGLE)
		{
	...
	*/
	this.addTextToModel = function(model, text, fontStyle, fontColour, backgroundColour)
	{
		...
		if (textureCanvas.getContext) 
		{
			...
			c3dl.debug.logWarning("addFloatingText(): call to create2Dcanvas() failed");
  ...
  */
  this.init = function()
  {
    if (renderer != null && canvasTag != null)
    {
      ...
      {
        c3dl.debug.logError("Your browser does not support WebGL.<br />" +
                            "Visit the <a href='http://en.wikipedia.org/wiki/WebGL'>WebGL wiki page</a> for information on downloading a WebGL enabled browser");
        return false;
      }
	...
	*/
	this.removeObjectFromScene = function(obj)
	{
		...
		if (obj instanceof c3dl.Primitive	||
			obj instanceof c3dl.Point		||
			obj instanceof c3dl.Line		||			
			obj instanceof c3dl.ParticleSystem)
		{
	...
	*/
	...
	{	
		...
		renderer.renderPoints(pointPositions, pointColors, pointAttenuation, 
								this.getPointSmooth(), this.getPointRenderingMode(), pointSize);
