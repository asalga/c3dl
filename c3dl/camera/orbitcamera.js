...
c3dl.OrbitCamera.prototype.toString = function(delimiter)
{
	...
	var OrbitCameraToStr =	"c3dl.OrbitCamera: "	+ delimiter +		
							"orbit point = "		+ this.getOrbitPoint() + delimiter +
							"closest distance = "	+ this.getClosestDistance() + delimiter +
							"farthest distance = "	+ this.getFarthestDistance();
